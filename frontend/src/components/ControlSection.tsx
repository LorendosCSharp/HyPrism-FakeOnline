...
export const ControlSection: React.FC<ControlSectionProps> = ({
  ...
  const openGitHub = () =>
    BrowserOpenURL("https://github.com/yyyumeniku/HyPrism");
  const openBugReport = () =>
    BrowserOpenURL("https://github.com/yyyumeniku/HyPrism/issues/new");
  const openCoffee = () =>
    BrowserOpenURL("https://buymeacoffee.com/yyyumeniku");
  ...
  const branchLabel =
    currentBranch === GameBranch.RELEASE ? t("Release") : t("Pre-Release");
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div
        className={`${selectorWidth} h-12 rounded-xl glass border border-white/5 flex items-center`}
      >
                    ...
                    >
                      <div className="flex items-center gap-2">
                        {currentVersion === version && (
                          <Check
                            size={14}
                            className="text-[#FFA845]"
                            strokeWidth={3}
                          />
                        )}
                        <span
                          className={
                            currentVersion === version ? "" : "ml-[22px]"
                          }
                        >
      ...
      <div className="flex gap-3 items-center">
        <NavBtn
          onClick={actions.showModManager}
          icon={<Package size={20} />}
          tooltip={t("Mod Manager")}
        />
        <NavBtn
          onClick={actions.setFakeOnline}
          icon={"FO"}
          tooltip={t(`Fake Online ${isFakeOnline}`)}
        />
        <NavBtn
          onClick={actions.openFolder}
          icon={<FolderOpen size={20} />}
          tooltip={t("Open Instance Folder")}
        />
        <NavBtn
          onClick={() => {
        ...
        <div className="flex-1 flex justify-center">
          <p className="text-white/40 text-xs whitespace-nowrap">
            ...
            <button
              onClick={() => BrowserOpenURL("https://hytale.com")}
              className="text-[#FFA845] font-semibold hover:underline cursor-pointer"
            >
              {t("BUY IT")}
            </button>
          </p>
        ...
        <div className="w-[200px] flex justify-end">
          {isGameRunning ? (
            ...
            <div className="flex flex-col items-center justify-center">
              <span>{t("Fake Online: ")+(isFakeOnline ? "On":"Off")}</span>
              <button
                onClick={onPlay}
